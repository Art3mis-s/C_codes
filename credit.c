...
int main(void)
{
    ...
    card1 = (card3 % 100 / 10) + (card3 % 10);
    card1 = (card4 % 100 / 10) + (card4 % 10);
    card1 = (card5 % 100 / 10) + (card5 % 10);
    card1 = (card6 % 100 / 10) + (card6 % 10);
    card1 = (card7 % 100 / 10) + (card7 % 10);
    card1 = (card8 % 100 / 10) + (card8 % 10);
    int sum1 = card1 + card2 + card3 + card4 + card5 + card6 + card7 + card8;

    //Now we need to find the digit that were not multiplied by 2
